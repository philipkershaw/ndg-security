...
class AttAuthority:
    ...
    def __init__(self, propFilePath, bReadMapConfig=True):
        ...
        # properties file
        self.__issuer = \
            self.__cert.getDN().serialise(separator=self.__prop['dnSeparator'])

        self.__issuerSerialNumber = self.__cert.getSerialNumber()
        ...
        try:
            ...
            raise AttAuthorityError(\
                "Error instantiating User Roles interface: %s" + e)
    ...
    def authorise(self,
        ...
        try:
            ...
            dtUsrProxyNotAfter = usrProxyCert.getNotAfter()
        ...
        if usrRoles:
            ...
            if extAttCertFilePath is None:
                if extAttCertFileTxt is None:
                    ...
                    # Parse externally provided certificate                     try:
                    try:
    ...
    def readProperties(self, propFilePath=None):
        ...
        for key in prop:
            if key != 'keyPwd' and prop[key]: prop[key] = prop[key].strip()
