...
class ProftpPDPTestCase(unittest.TestCase):
    ...
    def test1AccessPermitted(self):
        ...
        resrcHandle['dir'] = os.environ['NDGSEC_PDP_UNITTEST_DIR']
        userHandle['h'] =
        userHandle['sid'] = 
...
class ProftpPDPTestSuite(unittest.TestSuite):
    
    def __init__(self):
        print "ProftpPDPTestSuite ..."
        testCaseMap = map(ProftpPDPTestCase,
                          (
                            "test1AccessPermitted",
                          ))
