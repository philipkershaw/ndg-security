...
public class SessionMgrServiceLocator extends com.ibm.ws.webservices.multiprotocol.AgnosticService implements com.ibm.ws.webservices.multiprotocol.GeneratedService, ndg.security.SessionMgrService {
    ...
    public SessionMgrServiceLocator() {
        ...
        context.setLocatorName("ndg.security.SessionMgrServiceLocator");
    }
    ...
    private final java.lang.String sessionMgr_address = "http://glue.badc.rl.ac.uk/SessionManager";
    ...
    public ndg.security.SessionMgr getSessionMgr(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        ndg.security.SessionMgr _stub =
            (ndg.security.SessionMgr) getStub(
                sessionMgrPortName,
                (String) getPort2NamespaceMap().get(sessionMgrPortName),
                ndg.security.SessionMgr.class,
                "ndg.security.SessionMgrBindingStub",
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ndg.security.SessionMgr.class.isAssignableFrom(serviceEndpointInterface)) {
    ...
    public javax.xml.namespace.QName getServiceName() {
        return com.ibm.ws.webservices.engine.utils.QNameTable.createQName("urn:ndg:security", "SessionMgrService");
    }
    ...
    public javax.xml.rpc.Call[] getCalls(javax.xml.namespace.QName portName) throws javax.xml.rpc.ServiceException {
        ...
        if  (portName.getLocalPart().equals("SessionMgr")) {
            return new javax.xml.rpc.Call[] {
                ...
                createCall(portName, "reqAuthorisation", "null"),
