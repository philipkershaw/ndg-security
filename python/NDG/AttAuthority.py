...
class AttAuthority(dict):
    ...
    def readProperties(self, propFilePath=None):
        ...
        prop['attCertNotBeforeOff'] = float(prop['attCertNotBeforeOff'])
    ...
    def getTrustedHostInfo(self, **reqKeys):
        ...
        if 'role' not in reqKeys:
            ...
            trustedHostInfo = dict([(host, \
                {'wsdl': self.__mapConfig[host]['wsdl'], \
                 'pubKey': self.__mapConfig[host]['pubKey'], \
