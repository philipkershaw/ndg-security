...
class AttAuthorityServiceSub(AttAuthorityService, WSResource):
    ...
    def soap_getHostInfo(self, ps, **kw):
        ...
        request, response = AttAuthorityService.soap_getHostInfo(self, ps)
    ...
    def soap_getAllHostsInfo(self, ps, **kw):
        ...
        request, response = AttAuthorityService.soap_getAllHostsInfo(self, ps)
    ...
    def soap_getTrustedHostInfo(self, ps, **kw):
        ...
        request, response = \
                    	AttAuthorityService.soap_getTrustedHostInfo(self, ps)
    ...
    def soap_getX509Cert(self, ps, **kw):
        ...
        request, response = AttAuthorityService.soap_getX509Cert(self, ps)
        
        x509Cert = X509CertRead(srv.aa['certFile'])
...
if srv.aa['useSignatureHandler']:
    ...
    refC14nKw = {'unsuppressedPrefixes': srv.aa['wssRefInclNS']}
    signedInfoC14nKw = {'unsuppressedPrefixes':
                        srv.aa['wssSignedInfoInclNS']}
    
    WSSecurityHandler.signatureHandler = SignatureHandler(\
			                verifyingCertFilePath=srv.aa['clntCertFile'],
			                signingCertFilePath=srv.aa['certFile'],
			                signingPriKeyFilePath=srv.aa['keyFile'],
			                signingPriKeyPwd=srv.aa['keyPwd'],
