...
class XMLSecDoc(object):
    ...
    def __libxml2ParseDoc(self, xmlTxt):
        ...
        try:
            ...
            raise XMLSecDocError("Error parsing dccument: %s" % str(excep))
...
def testEncrypt(filePath="/home/users/pjkersha/Development/security/python/Tests/xmlsec/encrypt3-doc.xml",
    encrPubKeyFilePath="/home/users/pjkersha/Development/security/python/Tests/xmlsec/badc-aa-cert.pem"):
        
#    import pdb
#    pdb.set_trace()
    xmlSecDoc = XMLSecDoc()
    result = xmlSecDoc.encrypt(filePath=filePath, 
...
#_____________________________________________________________________________    
def testDecrypt(filePath="/home/users/pjkersha/Development/security/python/Tests/xmlsec/XMLSecDocEg.xml",
    encrPriKeyFilePath="/home/users/pjkersha/Development/security/python/Tests/xmlsec/badc-aa-key.pem",
    encrPriKeyPwd=None):
        
    import pdb
    pdb.set_trace()
    xmlSecDoc = XMLSecDoc()
    result = xmlSecDoc.decrypt(filePath=filePath, 
                               encrPriKeyFilePath=encrPriKeyFilePath,
...
#_____________________________________________________________________________
def testSym(\
filePath="/home/users/pjkersha/Development/security/python/Tests/xmlsec/encrypt3-doc.xml",
keyBinFilePath="/home/users/pjkersha/Development/security/python/Tests/xmlsec/deskey2.bin"):
        
    import pdb
    pdb.set_trace()
    xmlSecDoc = XMLSecDoc()
    encrRes = xmlSecDoc.symEncrypt(filePath=filePath,
                                   keyBinFilePath=keyBinFilePath,
                                   rtnAsString=True)
    print "Encrypted Result:"
    print encrRes
    
    decrRes = xmlSecDoc.symDecrypt(xmlTxt=encrRes,
                                   keyBinFilePath=keyBinFilePath,
                                   rtnAsString=True)
...
#_____________________________________________________________________________    
def testSymDecrypt(\
filePath="/home/users/pjkersha/Development/security/python/Tests/xmlsec/XMLSecDocEg2.xml",
keyBinFilePath="/home/users/pjkersha/Development/security/python/Tests/xmlsec/deskey.bin"):
