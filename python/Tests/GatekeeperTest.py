...
class GkResrcURIinterface(GatekeeperResrcURI):
...
class GatekeeperTestCase(unittest.TestCase):
    ...
    def setUp(self):
        try:
            self.gk = Gatekeeper(resrcURI='somewhere',
                                 resrcURImodFilePath='./GatekeeperTest.py',
                                 resrcURImodName='GatekeeperTest',
                                 resrcURIclassName='GkResrcURIinterface') 
        except Exception, e:
            self.fail(str(e))
