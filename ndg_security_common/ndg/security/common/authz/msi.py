...
try:
    ...
    warnings.warn("sessionmanager module import failed NdgPIP class will be "
                  "disabled: %s" % e)
    _sessionmanagerImportOK = False
...
class NdgPIP(PIPBase):
    ...
    def __init__(self, prefix='', **cfg):
        ...
        '''
        if _sessionmanagerImportOK == False:
            raise ImportError("Error with sessionmanager module import, this "
                              "class is disabled")
