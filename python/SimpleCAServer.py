...
[-c <configuration file path> | --conf=<configuration file path>]
    ...
    user is prompted for pass-phrase.
...
if __name__ == '__main__':
    ...
    try:
        simpleCA = SimpleCA(propFilePath=propFilePath, 
    ...
    # If no configuration file path was provided, read from stdin
        ...
        while nTries < 10:
            try:
                simpleCA.caPassPhrase = \
                    getpass.getpass(prompt="SimpleCA Pass-phrase: ")
                break
                ...
                if nTries >= 10:
                    ...
                    sys.stderr.write("Invalid Pass-phrase\n")
            
            except Exception, e:
                # Catch all
                sys.stderr.write(\
                    "Error checking Simple CA pass-phrase: %s\n" % e)
                sys.exit(1)
