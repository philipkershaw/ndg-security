...
class SignError(Exception):  
    """Raised form sign method if an error occurs generating the signature"""
...
class XMLSecDoc(object):
    ...
    def verifyEnvelopedSignature(self, xmlTxt=None):
        ...
        try:
            ...
            raise VerifyError, 'Failed to parse tranform node: %s' % str(e)
        ...
        try:
            ...
            raise VerifyError, 'failed to handle exclusive ' + \
                                'canonicalisation for SignedInfo: %s' % str(e)
