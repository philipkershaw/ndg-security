...
class AttributeAuthority(dict):
    ...
    @type ATTR_INTERFACE_KEYNAME: basestring
    @param ATTR_INTERFACE_KEYNAME: attribute interface parameters key name - 
    see _initAttributeInterface for details
    """
    ...
    ATTR_INTERFACE_KEYNAME = 'attributeInterface'
    
    attributeInterfacePropertyDefaults = {
        'modFilePath':  '',
        'modName':      NotImplemented,
    ...
    propertyDefaults = { 
        ...
        'dnSeparator':          '/',
        ATTR_INTERFACE_KEYNAME: attributeInterfacePropertyDefaults
    }
        ...
        try:
            ...
            raise AttributeAuthorityConfigError('Invalid directory path for '
                                                ...
                                                (self._prop['attCertDir'], 
                                                 osError.strerror))
    def _initAttributeInterface(self):
        ...
        keyName = AttributeAuthority.ATTR_INTERFACE_KEYNAME
        
        modName = self._prop[keyName].pop('modName')
        className = self._prop[keyName].pop('className')      
        modFilePath = self._prop[keyName].pop('modFilePath') 
                      
        self._attributeInterface = instantiateClass(modName,
                                         className,
                                         moduleFilePath=modFilePath,
                                         objectType=AttributeInterface,
                                         classProperties=self._prop[keyName])
    ...
    def getRoles(self, userId):
        ...
        try:
            return self._attributeInterface.getRoles(userId)
