...
class CredWallet(object):
    ...
    def __init__(self,
        ...
        setExtAttCertList:     behaviour for reqAuthorisation().  If True,
        ...
        self.__setExtAttCertList = setExtAttCertList
    ...
    def reqAuthorisation(self,
        ...
        setExtAttCertList:      make a list of certificates
                                ...
                                If no value is set, the default value held
                                in self.__setExtAttCertList is used
        ...
        if setExtAttCertList is not None:
            self.__setExtAttCertList = setExtAttCertList
        ...
        while True:
            ...
            try:
                ...
                if not mapFromTrustedHosts and not setExtAttCertList:
