"""NDG Security Context handler definition
...
class CtxHandlerInterface(PEPInterface):
    ...
    def pipQuery(self, request, designator):
        ...
        @param designator: desginator requiring additional subject attribute 
        information
