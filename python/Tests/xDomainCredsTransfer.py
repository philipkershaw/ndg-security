...
def setCookie(sessID=None, sessMgrURI=None, returnURI=None):
    ...
    cookie = SimpleCookie()
    if not sessID: sessID = base64.b64encode(os.urandom(128))
    if not sessMgrURI: sessMgrURI = base64.b64encode(os.urandom(32))
...
def showHomeSiteSelect(heading="NDG Home Site Select..."):
