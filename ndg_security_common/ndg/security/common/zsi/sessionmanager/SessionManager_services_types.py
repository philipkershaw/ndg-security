################################################## 
# SessionManager_services_types.py 
...
##############################
# targetNamespace
# urn:ndg:security:SessionManager
##############################

class ns0:
    targetNamespace = "urn:ndg:security:SessionManager"

    class getSessionStatus_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        literal = "getSessionStatus"
        schema = "urn:ndg:security:SessionManager"
        def __init__(self, **kw):
            ...
            kw["pname"] = ("urn:ndg:security:SessionManager","getSessionStatus")
    ...
    class getSessionStatusResponse_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            kw["pname"] = ("urn:ndg:security:SessionManager","getSessionStatusResponse")
    ...
    class connect_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            kw["pname"] = ("urn:ndg:security:SessionManager","connect")
            kw["aname"] = "_connect"
            self.attribute_typecode_dict = {}
            ZSI.TCcompound.ComplexType.__init__(self,None,TClist,inorder=0,**kw)
            class Holder:
    ...
    class disconnectResponse_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            TClist = []
            kw["pname"] = ("urn:ndg:security:SessionManager","disconnectResponse")
    ...
    class getAttCertResponse_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            kw["pname"] = ("urn:ndg:security:SessionManager","getAttCertResponse")
...
# end class ns0 (tns: urn:ndg:security:SessionManager)
