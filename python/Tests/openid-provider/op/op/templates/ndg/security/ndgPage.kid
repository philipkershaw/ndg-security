...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:py="http://purl.org/kid/ns#">
    ...
    <head py:def="pagehead()" py:strip="True">
        ...
        <script type="text/javascript" src="${g['server']}/js/toggleDiv.js"/>

        <link media="all, screen" href="${g['server']}/layout/ndg2.css" type="text/css" rel="stylesheet"/>
        <link rel="icon" type="image/ico" href="${g['server']}/layout/favicon.jpg" />
    </head>
