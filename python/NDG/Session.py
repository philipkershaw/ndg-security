...
# Use client package to allow redirection of authorisation requests
from NDG.SecurityClient import SessionClient
from NDG.SecurityClient import SessionClientError
