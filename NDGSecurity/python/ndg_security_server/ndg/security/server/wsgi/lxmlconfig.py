...
class LxmlConfigMiddleware(object):
    """Middleware that does nothing other than causing ndg_xacml, ndg_saml and
    ndg_security to be loaded and setting to True their flags for forcing lxml
    to be used or an exception to be raised if it is not available.
    """
