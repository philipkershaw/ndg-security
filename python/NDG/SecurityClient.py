...
class SessionClient(object):
    ...
    def __setClntPubKeyFilePath(self, clntPubKeyFilePath):
        ...
        try:
            ...
            raise SessionClientError, "Reading certificate file \"%s\": %s" %\
    ...
    def serviceProxy(self, smWSDL=None):
        ...
        try:
            ...
            raise SessionClientError, \
                ...
                (self.__smWSDL, e.status, e.reason)
    ...
    def reqAuthorisation(self,
        ...
        try:
            authzReq = smIO.AuthorisationReq(aaWSDL=aaWSDL,
                                 aaPubKey=aaPubKey,
                                 sessID=sessID, 
            ...
            resp = self.__smSrv.reqAuthorisation(authorisationReq=authzReq())
            authzResp = smIO.AuthorisationResp(\
