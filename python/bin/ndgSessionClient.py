...
#_____________________________________________________________________________
def setAApubKey(option, optStr, value, parser):
    """Parser callback function for reading Attribute Authority Public key"""
    
    try:
        parser.values.aaPubKey = open(value).read().strip()
...
"http://...""")
    ...
    parser.add_option("-m",
                      ...
                      default=False,
                      help=\
"""For use with --req-autho/-r flag.  Set to allow the Session Manager to
...
Attribute Certificates for mapping""")
    ...
    parser.add_option("-q",
                      ...
                      dest="reqRole",
                      help="""\
For use with --req-autho/-r flag.  Making certifcate mapping more efficient
...
back from the Attribute Authority""")
    ...
    parser.add_option("-l",
                      ...
                      default=False,
                      help=\
"""For use with --req-autho/-r flag.  Determines behaviour in the case where 
...
mapped Attribute Certificate from the import target Attribute Authority""")
    ...
    parser.add_option("-f",
                      ...
                      help=\
"""For use with --req-autho/-r flag.  A file of concatenated Attribute
...
Attribute Certificate""")
    ...
    parser.add_option("-t",
                      ...
                      help=\
"""For use with --req-autho/-r flag.  Pass a file containing a comma 
...
#    pdb.set_trace()
    ...
    try:
        sessClnt = SessionClient(smWSDL=options.sessMgrWSDLuri,
                             smPubKeyFilePath=options.smPubKeyFilePath,
                             clntPubKeyFilePath=options.clntPubKeyFilePath,
    ...
    try:
        ...
        if options.attAuthorityWSDLuri:
            methodCall = True
            ...
            authResp = sessClnt.reqAuthorisation(\
                            ...
                            aaWSDL=options.attAuthorityWSDLuri,
                            aaPubKey=options.aaPubKey,
