 ...
 * @author  gjd37
 */
public class TestACServer_3 {
    
    public TestACServer_3(String[] args) {
        ...
        try {
            ...
            */
            ...
            String tokenFileName = "C:/signedTokens/BADC_L0M9VUsvTz1lU2NpZW5jZS9PVT1DTFJDL0w9REwvQ049bmVpbCBiZW5uZXR0.xml";
  ...
  //          org.w3c.dom.Element xml  = acs.getAuthorisationTokenInDOM( cert3 );
            ...
            {
                System.out.println("**********************************************");
                System.out.println("No token returned, i.e. getAuthorisationTokenInDOM returns null.  This is because when we tried to generate a token " +
            ...
            */
            ...
            TokenReader reader = new TokenReader();
            uk.ac.cclrc.authorisation.AttributeList list =  reader.getACInfo( xml );
            
            // NDB - demo-code
            System.out.println("**********************************************");
            System.out.println("Read user's authorisation token back in and get roles from it");
            System.out.println("//////////////////////////////////////////////");
