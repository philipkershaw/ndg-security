...
# Handle retrieval of public key cert for Session Manager at remote location
import tempfile
import urllib
...
class SessionClient(object):
    ...
    def addUser(self,
        ...
        try:   
            ...
            addUserResp = AddUserResp(xmlTxt=resp['addUserResp'],
    ...
    def connect(self,
        ...
        try: 
            ...
            connectResp = ConnectResp(xmlTxt=resp['connectResp'],
                                encrPriKeyFilePath=self.__clntPriKeyFilePath,
                                encrPriKeyPwd=clntPriKeyPwd)
