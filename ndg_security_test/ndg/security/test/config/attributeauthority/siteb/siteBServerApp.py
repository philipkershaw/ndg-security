...
def infoApp(environ, start_response):
    response = "NDG Security Attribute Authority Unit Tests: Site B Server"
...
# To start the Site B Attribute Authority run 
# $ paster serve site-b.ini or run this file as a script
# $ ./siteBServerApp.py [port #]
if __name__ == '__main__':
    ...
    cfgFilePath = join(dirname(abspath(__file__)), 'site-b.ini')
