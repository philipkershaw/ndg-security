...
from ndg.security.server.AttAuthority.AttAuthority_services_server import \
	AttAuthorityService as _AttAuthorityService

from ndg.security.server.AttAuthority import AttAuthority, \
	AttAuthorityAccessDenied
...
#class AttributeAuthorityMiddleware(object):
#	   
#    def __init__(self, app, app_conf):
#        log.debug("AttributeAuthorityMiddleware.__init__ ...")
#        self.app = SOAPMiddleware(app, app_conf, 
#								  ServiceSOAPBinding=AttributeAuthorityWS(),
#								  pathInfo='/AttributeAuthority')
#                
#    def __call__(self, environ, start_response):
#		log.debug("AttributeAuthorityMiddleware.__call__")				
#
#		#start_response("200 OK", [('Content-type', 'text/xml')])
#		return self.app(environ, start_response)
       

class AttributeAuthorityWS(_AttAuthorityService):
    ...
    def soap_getHostInfo(self, ps, **kw):
        ...
        request, response = _AttAuthorityService.soap_getHostInfo(self, ps)
    ...
    def soap_getAllHostsInfo(self, ps, **kw):
        ...
        request, response = _AttAuthorityService.soap_getAllHostsInfo(self, ps)
    ...
    def soap_getTrustedHostInfo(self, ps, **kw):
        ...
        request, response = \
                    	_AttAuthorityService.soap_getTrustedHostInfo(self, ps)
    ...
    def soap_getX509Cert(self, ps, **kw):
        ...
        request, response = _AttAuthorityService.soap_getX509Cert(self, ps)
        
        x509Cert = X509CertRead(self.aa['certFile'])
