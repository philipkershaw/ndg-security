...
from ndg.security.common.AttAuthority.AttAuthority_services import *
...
<wsdl:definitions name=\"AttAuthority\" targetNamespace=\"urn:ndg:security:attAuthority\" xmlns=\"http://schemas.xmlsoap.org/wsdl/\" xmlns:http=\"http://schemas.xmlsoap.org/wsdl/http/\" xmlns:soap=\"http://schemas.xmlsoap.org/wsdl/soap/\" xmlns:soapenc=\"http://schemas.xmlsoap.org/soap/encoding/\" xmlns:tns=\"urn:ndg:security:attAuthority\" xmlns:wsdl=\"http://schemas.xmlsoap.org/wsdl/\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\">
  ...
  <wsdl:service name=\"AttAuthorityService\">
    ...
    def soap_getHostInfo(self, ps):
        ...
        # If we have an implementation object, copy the result 
        if hasattr(self,'impl'):
            # Should have a tuple of 6 args
            result._hostname = parameters[0]
            result._aaURI = parameters[1]
            result._aaDN = parameters[2]
            result._loginURI = parameters[3]
            result._loginServerDN = parameters[4]
            result._loginRequestServerDN = parameters[5]
        return self.request, result
